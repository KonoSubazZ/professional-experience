<template>
    <div class="table-info">
        <div class="mt-110-table" v-if="status == 'table'">
            <div>
                <div class="table font-14">
                    ...
                    <div class="max-table">
                        ...
                        >
                            <div
                                class="td t-27"
                                @click="showMoreInfo(item.positiveTitle)"
                            >
                                {{ item.positiveTitle }}
                            </div>
                            ...
                            <div
                                class="td t-13"
                                @click="showMoreInfo(item.callNumber)"
                            >
                                {{ item.callNumber }}
                            </div>
                            <div
                                class="td t-12"
                                @click="showMoreInfo(item.barCode)"
                            >
                                {{ item.barCode }}
                            </div>
                            <div
                                class="td t-13"
                                @click="showMoreInfo(item.code)"
                            >
                                {{ item.code }}
                            </div>
                            <div
                                class="td t-13"
                                @click="showMoreInfo(item.borrowAlso)"
                            >
                                {{ item.borrowAlso }}
                            </div>
...
export default {
    data() {
        return {
            timeout: "",
            orderInfo: {}, //逾期订单信息
            status: "table", //table,code,fail,success
            list: [
                {
                    name: "选择认证方式",
                    select: true,
