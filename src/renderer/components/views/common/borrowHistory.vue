<template>
    <div class="table-info mt-110-table">
        ...
        <div class="flex-row flex-center mt-40" v-if="status == 'confirm'">
            ...
            <button
                v-if="
                    manageSetting.selfServiceBorrowIsPrint &&
                    bookList &&
                    bookList.length
                "
    ...
    methods: {
        ...
        setPrintStr() {
            ...
            this.bookList.forEach((it) => {
                ...
                bookStr =
                    bookStr + `${it.positiveTitle}|${it.barCode}|${time}\n`;
            });
            let line = "-------------------\n";
