<template>
    <div id="background">
            ...
            <div class="header-body posi-abso flex-row flex-between align-center">
                ...
                <div class="header-operating color-white text-center">
                    ...
                    <button class="operating-menu pointer pd-20" id="menu-btn" v-if="userInfo && userInfo.name"
                        @blur="showMenu = false" @click="openMenu">
                        <div class="font-24">
        ...
        <div class="caption-user flex-row">
            <div class="user-info flex-row color-white" v-if="userInfo && userInfo.name">
            ...
            <captionTime :time="time" v-if="setting.showTime" :color="'#53EEFF'"></captionTime>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            typeKeyList: {
                borrow: "selfServiceBorrowIsLoan",
                return: "selfServiceBorrowIsRestitution",
                renew: "selfServiceBorrowIsRenew",
                search: "selfServiceBorrowIsInquire",
            },
            showMenu: false,
            menuList: [
                {
...
#background {
    ...
    .back-body {
        ...
        height: 70%;
        background-color: white;
        background-image: url("~@/assets/images/dark/body_bg.png");
