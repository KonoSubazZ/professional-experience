<template>
  <div class="keyboard" :style="{ top: top + 'px', left: 350 + 'px' }">
    <!-- <div class="number-keyboard">
      <div
        class="number-item"
        v-for="(item, index) in numberList"top
        :key="index"
    ...
    <div class="str-keyboard" v-if="!pinyinStatus">
      <div class="str-line">
        ...
        <div class="str-item font-bold" style="border-right:1px solid rgba(0, 0, 0, 0.15)" @click.stop="clickNumber('.')">.</div>
        <div class="str-item color-red" @click.stop="clickNumber('del')">
          删除
        </div>  
      ...
      <div class="str-line">
        ...
        <div class="str-item font-bold" @click.stop="clickNumber('/')">/</div>
        <div class="str-item color-red" @click.stop="clickNumber(';')">
          ;
        </div>
