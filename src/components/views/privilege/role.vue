<template>
    <div>
        ...
        <!-- 弹框 -->
        <el-dialog title="角色设置" :visible.sync="dialogFormVisible" top='3vh' width="80%" :close-on-click-modal='false' @close='close' >
            <el-form :model="form"   :rules="rules" ref="form"  >
                <el-form-item  >
                    <div>角色名称</div>
                    <el-input v-model="form.name" ></el-input>
                </el-form-item>
                <el-form-item  class="over">
          ...
          if(arr.length>0){
           ...
           obj.map(it=>{
                ...
                if(it.permissions.length>0){
                    ...
                    this.selectAll(value,it.sub)
                }
              
               
            })
            this.checkAll = this.permissionsLists
        },
        // 获取权限
        getPermission(tag){
