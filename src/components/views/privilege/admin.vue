<template>
    <div>
        ...
        <!-- 弹框 -->
        <el-dialog title="管理员管理" :visible.sync="dialogFormVisible" width="70%" :close-on-click-modal="false">
...
export default {
    ...
    data() {
        return { bus: this.bus(this), dialogFormVisible: false, info: {}, loadings: false, idrow: '' };
    },
    created() {},
    methods: {
        editUpdate(e) {
