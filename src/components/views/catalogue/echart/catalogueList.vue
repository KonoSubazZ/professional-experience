    ...
    <div class="container padding_20">
        <div class="display_flex between header_title padding_20 m-b-20">
            ...
            <div class="display_flex">
                <el-button-group>
                    <el-button type="primary" plain class="add m-r-20" icon="el-icon-download"
                        @click="exportAll">导出</el-button>
                    <el-button type="primary" plain class="add m-r-20" icon="el-icon-printer"
                        @click="printing">打印</el-button>
        ...
        <div id="workInfo">
            <List :isHeaderHeigt="80" :data="data" :disableMeta="true" :tableMeta="meta" :disableFilter="true"
                :disableTableAction="true" @search="search" v-loading="load" ref="list"></List>
        </div>
...
export default {
    components: { List },
    data() {
        return { bus: this.bus(this), meta: '', form: {}, data: {}, arr: [], load: false, lists: [], format: '', list: [] };
    },
    created() {
        ...
        exportAll() {
            ...
            this.ax
                ...
                .then((res) => {
                    ...
                    // link.setAttribute("download", "x.xlsx");
        ...
        getList() {
            ...
            this.ax.get(url, { params: this.form }).then((res) => {
                ...
                res.content.map((it) => {
                    ...
                    // if (it.subTitle && it.subTitle != 'NULL') {
                    //     it.allTitle += ':' + it.subTitle;
                    // }
                    // if (it.sectionTitle && it.sectionTitle != 'NULL') {
                    //     it.allTitle += '/' + it.sectionTitle;
                    // }
                    // if (it.sectionNumber && it.sectionNumber != 'NULL') {
                    ...
                    if (it.auxiliaryNumber && it.auxiliaryNumber != 'NULL') {
                        it.allTitle += '.' + it.auxiliaryNumber;
                    }
                    if (it.subTitle) {
            ...
            if (this.form.fun == 2) {
                ...
                this.meta = {
                    ...
                    subs: [
                        ...
                        { name: '馆藏总金额', key: 'totalBookPrice', displayInList: true }
                    ]
                };
            }
        },
