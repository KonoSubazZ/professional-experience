 <template>
    <div class="container">
         <List 
            :dataUrl="'/manage/unit/catalog/catalogingParameters/batch'"
            :disableMeta='true'
            :tableMeta='meta'
            @edit="editUpdate"
            ref="list"
...
export default {
    ...
    methods: {
        ...
        deleteUpdate(e){
            ...
            this.loading()
            this.ax.delete('/manage/unit/catalog/catalogingParameters/batch?ids='+ids)
                .then(res=>{
                     this.sloading()
                    this.bus.$emit(`flash_/manage/unit/catalog/catalogingParameters/batch`, res);
         ...
         save_mar(formName){
             this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    this.ax.post('/manage/unit/catalog/catalogingParameters/batch',this.form)
                        .then(res=>{
                            this.sloading()
