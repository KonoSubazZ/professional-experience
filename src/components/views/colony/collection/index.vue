    ...
    <div class="container">
        <div class="searchInfo display_flex between padding_20">
            <div class="display_flex flex_center w-80">
                <view-form :list="list" :model="form" :labelWidth="'100px'"></view-form>
            ...
            <div class="m-b-30">
                <el-button-group>
                    <el-button
                        ...
                        @click="exportData('/manage/united/collectionStatistics/collectionStatisticsExcel')"
                        >导出</el-button
                    >
                    <el-button type="primary" plain icon="el-icon-printer" @click="print('col')">打印</el-button>
                </el-button-group>
            </div>
        </div>

        <div :style="$height(210)" class="over">
            <div class="padding_20 m-b-20" id="col">
                <el-table :data="tableData" stripe show-summary style="width: 100%">
                    <el-table-column type="index" width="50"> </el-table-column>
                    <el-table-column prop="name" label="单位名称"> </el-table-column>
                    <el-table-column prop="countryAverageBookCollection" label="国家标准"> </el-table-column>
                    <el-table-column prop="bookNumber" label="馆藏册数"> </el-table-column>
                    <el-table-column prop="averageBookCollection" label="平均复本"> </el-table-column>
                    <el-table-column prop="supplementNumber" label="应补数"> </el-table-column>
                    <el-table-column prop="status" label="达标情况">
...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            this.form.size = 999;
            this.ax
                .get('/manage/united/collectionStatistics/collectionStatistics', { params: this.form })
                .then((res) => {
                    ...
                    let series = [[], [], [], []];
                    res.content.map((it) => {
                        series[0].push(it.countryAverageBookCollection);
                        series[1].push(it.bookNumber);
                    ...
                    // console.log(series)
                    this.drawLine('chart1', arr, series, ['#2699FB', '#FFAE71', '#5BD1A5', '#FB8180']);
                })
                // {
                //     name: 'Forest',
                //     type: 'bar',
