 <template>
    <div class="container">       
            ...
            <template slot="addition-actions" >
                <el-button-group>
                                 <el-button type="primary" plain icon="el-icon-folder-add"  @click="save" >装订</el-button>
                                  <el-button type="primary" plain icon="el-icon-caret-left"  @click="back" >返回</el-button>
                    </el-button-group>
                <!-- <div
                    @click="back"
                ...
                <div
                    ...
                    class="text_center cursor m-r-20"
                >
                    <img src="../../../../assets/img/and.png" class="btn_img" />
                    <div class="f-s-14">装订</div>
                </div> -->
    ...
    methods: {
        ...
        del(e) {
            ...
            this.ax
                ...
                .then(res => {
                    this.sloading();
                    this.bus.$emit(`flash_/manage/unit/journal/journalBookingBinding/journalBookingDetailById?journalBookingId=${this.journalBookingId}`);
