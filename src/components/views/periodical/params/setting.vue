        ...
        <div class="padding_20">
                ...
                <el-tab-pane label="本馆参数配置" name="BOOK">
                    <div>
                        <!-- <el-form ref="form" :model="form" label-width="160px">
                            <el-form-item label="Z39.50下载模式">
                                <el-radio-group v-model="form.downloadMode">
                                <el-radio :label="1">先简后详(节约数据用量)</el-radio>
                                <el-radio :label="2">直接下载详细MARC(可能造成浪费）</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="条码是否自动记忆">
                                <el-radio-group v-model="form.automaticMemory">
                                <el-radio :label='true'>自动记忆</el-radio>
                                <el-radio :label="false">人工填写</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="保存后是否弹出新增查重界面">
                                <el-radio-group v-model="form.newCheck">
                                <el-radio :label="true">是</el-radio>
                                <el-radio :label="false">否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="非中央库数据是否直接套路(仅限命中1条)">
                                <el-radio-group v-model="form.directCopy">
                                <el-radio :label="true">是</el-radio>
                                <el-radio :label="false">否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="无命中数据是否直接新增记录弹窗">
                                <el-radio-group v-model="form.directAdd">
                                <el-radio :label="true">是</el-radio>
                                <el-radio :label="false">否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="中央库数据是否直接添加复本(仅限命中1条)">
                                <el-radio-group v-model="form.directDuplication">
                                <el-radio :label="true">是</el-radio>
                                <el-radio :label="false">否</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="默认打开编目方式">
                                ...
                                <el-radio :label="1">表单编目</el-radio>
                                <el-radio :label="2">MARC编目</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <el-form-item label="不规范MARC保存（MARC实时检测）">
                                <el-radio-group v-model="form.marcTesting">
                                <el-radio :label="true">是</el-radio>
                                <el-radio :label="false">否</el-radio>
                                </el-radio-group>
                            </el-form-item>

                             <el-form-item label="种次号是否补缺生成">
                              ...
                              <el-form-item label="索书号重复是否可保存">
                                <el-radio-group v-model="form.callNumberType">
                                <el-radio :label="true">是</el-radio>
                                <el-radio :label="false">否</el-radio>
                                </el-radio-group>
                            </el-form-item>
            ...
            <div class="display_flex choose">
                     <el-button-group>
                                ...
                                <el-button type="primary" plain icon="el-icon-refresh-left"  @click="back" >还原</el-button>
                    </el-button-group>
                    <!-- <div @click="save('form')" class="text_center cursor m-r-20">
                        <img src="../../../../assets/img/saves.png" class="btn_img" />
                        <div class="f-s-14">保存</div>
                    </div> 
                    <div @click="back" class="text_center cursor m-r-20">
                        <img src="../../../../assets/img/reback.png" class="btn_img" />
                        <div class="f-s-14">还原(R)</div>
                    </div> -->
            </div>
        </div>
      ...
      calcTableHeight(val) {
        ...
        getSetting(){
            let params={
             ...
             this.ax.get('/manage/unit/journal/journalParameters/catalogSetting',{params})
                .then(res=>{
            ...
            this.ax.get('/manage/unit/catalog/catalogingParameters/marcDatabase',{params:{platformId:JSON.parse(localStorage.getItem("user")).platform.id}})
                .then(res=>{
                        ...
                        res.content.map((it,i)=>{
                                if(it.isUsing){
                                    // let obj = res.content.splice(i,1)[0]
        ...
        save(){
           ...
           if(this.activeName=='BOOK'){
               this.ax.post('/manage/unit/journal/journalParameters/catalogSetting',this.form)
                .then(res=>{
