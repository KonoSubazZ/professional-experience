<template>
    <div>
        ...
        >
            <div>
                <set-view
                    :url="'/manage/unit/journal/journalExcel/journalBookingReceiveResDisForExcelField'"
...
export default {
            ...
            list: [
                // { name: '文献类型', id: 'medium', type: 'select', options: [] },
                {
                  ...
                  { name: '订购年份', id: 'year' },
                   ...
                   { name: '预定批次', id: 'batchId', type: 'select', relation: 'batchName', options: [] },

                   { name: '供货单位', id: 'deliveryUnitId',relation: 'deliveryUnit',  type: 'select', options: []  },

                    // { name: '文献来源', id: 'literatureSource' },

                    // { name: '状态', id: 'bookStatus', type: 'select' , options: [] },
                ...
                { name: '出版周期', id: 'cycleId', relation: 'cycleName',type: 'select',  options: [] },

                 { name: '分发馆藏地', id: 'distributionCollectionPlaceId',relation:'distributionCollectionPlaceName', type: 'select',  options: [] },


                { name: '期数-期', id: 'cycleNumber' },
    ...
    methods: {
      calcTableHeight(val) {
        ...
        lookFor() {
            this.$router.push({
                path: '/periodical/echart/distributeList',
        ...
        // 获取馆藏地
        getPlace() {
            this.ax.get('/manage/unit/report/journalReport/journalCollection',{params:{ type:'DISTRIBUTION',platformId:JSON.parse(localStorage.getItem("user")).platform.id}}).then(res => {
