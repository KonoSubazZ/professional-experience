<template>
    <div>
        ...
        >
            <div>
                <set-view
                    :url="form.fun==1?'/manage/unit/journal/journalExcel/journalBaseResForExcelField':'/manage/unit/journal/journalExcel/journalResForExcelField'"
...
export default {
    ...
    methods: {
      calcTableHeight(val) {
        ...
        lookFor() {
            this.$router.push({
                path: '/periodical/echart/catalogueList',
