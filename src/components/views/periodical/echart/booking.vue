<template>
    <div>
        ...
        >
            <div>
                <set-view
                    :url="'/manage/unit/journal/journalExcel/journalBookingForExcelField'"
...
export default {
    ...
    data() {
        return {bus: this.bus(this),
            list: [
                ...
                // { name: '文献来源', id: 'literatureSource', type: 'select',  options: [] },
                ...
                // { name: '状态', id: 'readerUnitName', type: 'select', relation: 'readerUnitNameId', options: [] },
    ...
    methods: {
      calcTableHeight(val) {
        ...
        lookFor() {
            this.$router.push({
                path: '/periodical/echart/bookingList',
