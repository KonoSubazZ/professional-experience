<template>
    <div>
        <div class="container" :style="'height:'+height+'px'">
            <div class="display_flex between header_title padding_20 m-b-20">
                ...
                <div class="display_flex">
                       <el-button-group>
                                <el-button type="primary" plain class="add m-r-20" icon='el-icon-caret-left' @click="lookMarc(-1)" >上一条Marc记录</el-button>
                                <el-button type="primary" plain icon="el-icon-caret-right"  @click="lookMarc(1)" >下一条Marc记录</el-button>
        ...
        <el-dialog
           ...
           <div>总数：{{countNumber.totalNumber}}</div>
    ...
    methods: {
      calcTableHeight(val) {
        ...
        getMarc(index){
            ...
            this.loading()
            this.ax.post('/manage/unit/system/dataReceive/jxMarc',{marc:this.marc[index-1],enCoding:this.info.enCoding})
                .then(res=>{
                    // console.log(res)
                      this.sloading()
                   res.map(it=>{
        ...
        add(){
            ...
            this.ax.post('/manage/unit/system/dataReceive/jxBookBaseLibraryRes',params)
                .then(res=>{
            ...
            this.ax.get('/manage/unit/system/dataReceive/plannedSpeed',{params:{key:this.key}})
                .then(res=>{
                    try {
                        ...
                        if(res.totalNumber!=res.nowNumber){
