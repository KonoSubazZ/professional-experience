        ...
        <div id="A4">
            <div class="A4">
                <el-table :data="data" show-summary :summary-method="getSummaries" stripe style="width: 100%">
                    ...
                    <el-table-column width="340" prop="name" label="统计项目名称" sortable> </el-table-column>

                    <el-table-column prop="classificationNumber" label="文献种数" sortable> </el-table-column>

                    <el-table-column prop="number" label="文献册数" sortable> </el-table-column>

                    <el-table-column prop="totalPrice" label="金额码洋" sortable> </el-table-column>

                    <el-table-column prop="percentage" label="册数占比" sortable> </el-table-column>
                </el-table>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            this.ax.get('/manage/unit/catalog/catalogExcel/bookBaseTogetherRes', { params: this.form }).then((res) => {
                //获取内容   需要修改
                this.data = res;
            });
        },
