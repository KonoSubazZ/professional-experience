        ...
        <div id="A4">
            <div class="A4">
                <el-table :data="data" show-summary :summary-method="getSummaries" stripe style="width: 100%">
                    ...
                    <el-table-column prop="name" label="分类名称" width="340" sortable> </el-table-column>

                    <el-table-column prop="classificationNumber" label="分类号" width="100" sortable> </el-table-column>

                    <el-table-column prop="totalPrice" label="金额" width="100" sortable> </el-table-column>

                    <el-table-column prop="number" label="册数" sortable> </el-table-column>

                    <el-table-column prop="percentage" width="100" label="百分比" sortable> </el-table-column>
                </el-table>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            this.ax.get('/manage/unit/catalog/catalogExcel/classificationRes', { params: this.form }).then((res) => {
                //获取内容   需要修改
                this.data = res;
            });
        },
