...
export default {
    ...
    created() {
        ...
        if (this.$route.query.info) {
            // this.getListData(this.$route.query.info)
    ...
    methods: {
        ...
        getListData(id){
            this.ax.get('/manage/unit/opac/announcement/museumSystemDetail?museumSystemId='+id)
                .then(res=>{
        ...
        save(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    this.ax.post('/manage/unit/opac/announcement/museumSystem', this.ruleForm).then(res => {
                        this.$message.success('保存成功');
                        this.ruleForm = {
                            content: '',
                            title: ''
                        };
                        this.bus.$emit(`flash_/manage/unit/opac/announcement/museumSystem`, res);
                        this.back();
                    });
                } else {
