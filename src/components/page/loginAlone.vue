            ...
            <div class="login_box display_flex">
                ...
                <div class="input_box">
                    <div class="login_header m-b-45">
                        ...
                        <!-- <div class="btn_choose cursor" :class="type_btn==2?'active_btn':''"  @click="type_btn=2">
                            <div class="m-b-20">
                                子平台登录
                            </div>
                    ...
                    <el-form :model="param" :rules="rules" ref="login" label-width="0px" class="ms-content">
                        <!-- <el-form-item prop="platformId" v-if="type_btn==2">
                            ...
                            <el-select v-model="param.platformId" placeholder="请选择" class="w-100">
...
export default {
    ...
    created() {
        ...
        if (!this.$route.query.id) {
            return this.$message.error('错误地址，请输入正确的地址');
        }
        this.param.platformId = this.$route.query.id;

        localStorage.setItem('alone', 1);
